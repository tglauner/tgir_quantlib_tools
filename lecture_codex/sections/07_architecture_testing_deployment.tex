...
{Commit 65a2acb; docs/DEPLOYMENT.md; SESSION\_HANDOFF.md.}
...
{docs/DEPLOYMENT.md; deploy templates.}
...
\begin{frame}{Production request path}
  ...
  \src{deploy/apache and deploy/systemd templates; docs/DEPLOYMENT.md.}
\end{frame}
...
{docs/DEPLOYMENT.md; August 2026 deployment verification.}
