...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture,overlay]
    ...
    {\usebeamerfont{title}\color{white}Building a QuantLib Derivatives Workbench\par\vspace{4mm}
     ...
     \color{white!70}\normalsize Tim Glauner + two coding agents\hfill Evidence through 22 August 2026};
  \end{tikzpicture}
...
\begin{frame}{A small technical stack became the agents' shared workbench}
  ...
  \src{ARCHITECTURE.md; app factory, routes, deployment files, and GitHub Actions history.}
\end{frame}
...
\begin{frame}{DigitalOcean keeps production deliberately small}
  ...
  \src{DEPLOYMENT.md; GitHub deploy workflow; Apache and systemd templates.}
\end{frame}
