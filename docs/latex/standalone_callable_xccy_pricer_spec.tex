...
\usepackage{lmodern}
\usepackage[letterpaper,top=0.48in,bottom=0.50in,left=0.55in,right=0.55in,headsep=7pt,footskip=17pt]{geometry}
...
\usepackage{titlesec}
\usepackage{listings}
\usepackage{mastering_ir_derivatives_article}

\definecolor{QuantNavy}{HTML}{17324D}
\definecolor{QuantBlue}{HTML}{2D678F}
\definecolor{QuantGray}{HTML}{5D6873}
\definecolor{CodeBg}{HTML}{F4F6F8}
\hypersetup{colorlinks=true,linkcolor=QuantBlue,urlcolor=QuantBlue,
  pdftitle={Standalone Callable EUR-USD Cross-Currency Swap Pricer Specification},
  pdfauthor={TG Investments and Research}}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{QuantGray}Implementation Specification}
\fancyhead[R]{\small\color{QuantGray}Standalone Callable EUR-USD XCCY Pricer}
\fancyfoot[C]{\small\color{QuantGray}Page \thepage\ of 3}
\renewcommand{\headrulewidth}{0.3pt}
\setlength{\headheight}{12pt}
\setlength{\parindent}{0pt}
\setlength{\parskip}{1.4pt plus 0.3pt minus 0.3pt}
\setlist[itemize]{leftmargin=*,itemsep=0.4pt,topsep=1.2pt,parsep=0pt}
\setlist[enumerate]{leftmargin=*,itemsep=0.4pt,topsep=1.2pt,parsep=0pt}
\titlespacing*{\section}{0pt}{4.5pt}{1.2pt}
\titlespacing*{\subsection}{0pt}{3pt}{0.8pt}
...
\lstset{basicstyle=\ttfamily\scriptsize,backgroundcolor=\color{CodeBg},frame=single,
  columns=fullflexible,breaklines=true,aboveskip=2pt,belowskip=2pt,xleftmargin=2pt,xrightmargin=2pt}
...
{\Large\bfseries\color{QuantNavy} Standalone Callable EUR-USD Cross-Currency Swap Pricer}
...
\section{1. Scope and benchmark trade}
...
\section{2. Files, command, and validation}
...
\newpage
\section{3. Model under the USD measure}
...
\newpage
\section{5. Cash flows and Bermudan LSM}
...
\section{6. Numerical controls and acceptance}
...
\section{7. Deliverable boundary}
