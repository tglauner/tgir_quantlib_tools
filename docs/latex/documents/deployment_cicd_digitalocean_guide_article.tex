...
\title{Deployment, CI/CD, and DigitalOcean Guide}
...
\begin{table}[!t]
\caption{GitHub Actions deployment secrets}
\centering
\begin{tabularx}{\columnwidth}{>{\raggedright\arraybackslash}p{0.39\columnwidth}X}
\toprule
Secret & Purpose \\
\midrule
