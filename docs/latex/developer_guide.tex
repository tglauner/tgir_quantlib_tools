...
\begin{itemize}[leftmargin=1.5em]
    \item \code{market} for rates, swaption volatility, shared mean reversion, and SPX equity assumptions,
    \item \code{trades.swap},
    \item \code{trades.european\_swaption},
    \item \code{trades.bermudan\_swaption}, and
    \item \code{trades.bermudan\_swaption\_2}, and
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item European Hull-White 1F + Jamshidian pricing,
    \item Bermudan Hull-White 1F / G2++ calibration and tree pricing,
    \item price tables,
